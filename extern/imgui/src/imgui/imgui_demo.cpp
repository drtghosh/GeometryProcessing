...
static void ShowDemoWindowTables()
{
    ...
    if (ImGui::TreeNode("Padding"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("Disable inner padding between columns (double inner padding if BordersOuterV is on, single inner padding if BordersOuterV is "
                   "off)");
    ...
    if (ImGui::TreeNode("Sorting"))
    {
        ...
        ImGui::SameLine();
        HelpMarker("When sorting is enabled: allow no sorting, disable default sorting. TableGetSortSpecs() may return specs where (SpecsCount == "
                   "0).");
        PopStyleCompact();
